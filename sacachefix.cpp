		...
		istringstream iss(operation);
                ...
                if(operation == "FF")
                {
                    ...
                    if(miss)            //write miss
                    {
                        ...
                        if(cache[replace].data[offset] != dataTemp)                     //added if statement to check and see if data would be changed
                        {
                    ...
                    {
                        if(cache[index].data[offset] != dataTemp)
                        {
